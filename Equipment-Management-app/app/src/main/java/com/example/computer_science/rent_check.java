...
public class rent_check extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rent_check.InsertData task = new rent_check.InsertData();
        task.execute("http://" + IP_ADDRESS + "/rent_check_pid.php", p_ids);

        GetData tasks = new GetData();
        tasks.execute( "http://" + IP_ADDRESS + "/rent_check.php", "");
        ...
        r_date = (TextView)findViewById(R.id.textView14);
    ...
    class InsertData extends AsyncTask<String, Void, String>{
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(rent_check.this,
    ...
    private void showResult(){
        ...
        try {
            ...
            for(int i=0;i<jsonArray.length();i++){
                ...
                String r_dates= item.getString(TAG_r_date);
