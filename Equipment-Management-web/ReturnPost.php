 ...
 <div id="GridForMenuAndArticle">
   <ol>
     ...
     <div id="article">
       ...
       $query="UPDATE Rent
               SET r_check = '0', r_studentID = NULL, r_date = NULL, extension_check = '0', extension_date = NULL
               WHERE p_id = $pid";
       ...
       if($result){
         mysqli_close($conn);
         echo '<h3><p style = "color : #0D3EA3;"><<반납완료>></p></h3>';
         ...
         mysqli_close($conn);
         echo '<p style = "color : black;"> 반납을 실패하였습니다. 입력 정보를 다시 확인하세요.</p>';
       }
        ?>

        <p><button style= "background-color : white; text-align : center; color : black; font-size : 35px;" onclick="location.href = 'Return.php'" > 확인 </button></p>
