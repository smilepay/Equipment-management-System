...
<div id="GridForMenuAndArticle">
  <ol>
    ...
    <div id="article">
      <form action="RentalPost.php" method="post">
        ...
        <p>대여자 연락처 : <input type = "text"  name="s_phone" style = "font-size : 25pt; width : 320px;"></p>
        <p>대여 날짜   : <input type ="date"  name="r_date" style = "font-size : 25pt; width : 320px;">
        <p> <input type = "submit" value="대여하기" style = "font-size : 30pt; background-color : white; color : #0D3EA3; padding-left:30px;padding-right:30px; margin-left:110px; margin-top:40px;"></p>
      </form>
