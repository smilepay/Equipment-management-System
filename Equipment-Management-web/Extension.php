...
<div id="GridForMenuAndArticle">
  <ol>
    ...
    <button class="cbtn" onclick="location.href = 'Extension.php'" > 대여 연장 </button>
    <button class="btn hover1" onclick="location.href = 'RentalView.php'" > 대여 현황 조회 </button>
  </ol>

  <div id="article">
    <form action="ExtensionPost.php" method="post">
      ...
      <p>연장 날짜   : <input type ="date"  name="extension_date" style = "font-size : 25pt; width : 320px;">
      <p> <input type = "submit" value="연장하기" style = "font-size : 30pt; background-color : white; color : #0D3EA3; padding-left:30px;padding-right:30px; margin-left:110px; margin-top:40px;"></p>
    </form>
