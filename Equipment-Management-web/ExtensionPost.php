 ...
 <div id="GridForMenuAndArticle">
   <ol>
     ...
     <div id="article">
       ...
       $sname=$_POST['s_name'];
       $extensiondate= (string)$_POST['extension_date'];

       $query="UPDATE Rent
               SET extension_check = '1', extension_date = '$extensiondate'
               WHERE p_id = $pid ";
       ...
       if($result){
         mysqli_close($conn);
         echo '<h3><p style = "color : #0D3EA3;"><<연장완료>></p></h3>';
         echo '<p><b>대여자 성함 : </b>'.$sname;
         echo '<p><b>대여자 학번 : </b>'.$sid;
         echo '<p><b>물품 종류 : </b>'.$pname;
         echo '<p><b>물품 번호 : </b>'.$pid;
         echo '<p><b>연장한 날짜 : </b>'.$extensiondate;
       }
       else {
         mysqli_close($conn);
         echo '연장을 실패하였습니다. 입력 정보를 다시 확인하세요.';
       }
        ?>
