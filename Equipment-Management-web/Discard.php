...
<div id="GridForMenuAndArticle">
  ...
  <div id="article">
    ...
    <form action="DiscardPost.php" method="post">
      ...
      폐기 날짜 입력 : <input type = "date" name="d_date" style = "font-size : 15pt; width : 250px;">
      <input type = "submit" value="폐기" style = "font-size : 20pt; background-color : white; color : #0D3EA3; padding-left:30px;padding-right:30px; margin-left:50px; margin-top:40px;">
    </form>
